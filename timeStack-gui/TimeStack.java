...
public class TimeStack {
	...
	private JButton buttonBC1_1 = new JButton("Transaction 생성");
	private JButton buttonBC1_2 = new JButton("Transaction 전송");
	private JPanel panelBC2 = new JPanel();
	private JList listBC2_1 = new JList();
	private JList listBC2_2 = new JList();
	...
	public void initialize() {
		...
		button2_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				LineBorder BC1_1BorderA = new LineBorder(
						SystemColor.activeCaption, 5, true);
				EmptyBorder BC1_1BorderB = new EmptyBorder(20, 20, 20, 20);
				buttonBC1_1.setBorder(new CompoundBorder(BC1_1BorderA,
						BC1_1BorderB));
				...
				LineBorder BC1_2BorderA = new LineBorder(
						SystemColor.activeCaption, 5, true);
				EmptyBorder BC1_2BorderB = new EmptyBorder(20, 20, 20, 20);
				buttonBC1_2.setBorder(new CompoundBorder(BC1_2BorderA,
						BC1_2BorderB));
		...
		panelS1_0.setBackground(SystemColor.BLUE);
		...
		labelS1_1.setBackground(SystemColor.BLUE);
		...
		// BorderLayout.NORTH);
		panelS1_1.setBackground(SystemColor.BLUE);
		...
		RadioButtonS1_1_1.setBackground(SystemColor.BLUE);
		...
		panel3.setBackground(SystemColor.BLUE);
		/** 패널3 안에 레이블3 */
