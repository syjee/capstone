	...
	public void initialize() {
		...
		button2_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				STimeSync.setBounds(1500, 500, 900, 800);
				...
				RadioButtonS1_1_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String strNewTime = sdf.format(calendar.getTime());
		...
		tr.timereceive();
		if(tr.offsetValue < 0) {
			label3.setText("사용자의 PC가 "+tr.offsetValue*(-0.001)+"초 느립니다.");
		} else {
			label3.setText("사용자의 PC가 "+tr.offsetValue*0.001+"초 빠릅니다.");
		}
