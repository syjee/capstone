                ...
                { 
                    ...
                    { 
                        ...
                        { 
                            ...
                            { 
                                System.out.println("Sending " + outputBuffer.get(i).getCurrentHash().substring(0, 20) + " to " + socket.getInetAddress()); 
                            } 
                            else 
                            { 
                                System.out.println("Sending " + outputBuffer.get(i).getCurrentHash() + " to " + socket.getInetAddress()); 
                            } 
