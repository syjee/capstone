...
//    private ArrayList<String> receivedData = new ArrayList<String>(); 
    ...
    public RPCInput(Socket socket,PeerNetworkManager pm,KeyManager km) 
    { 
        this.socket = socket; 
        this.pm = pm;
    ...
    public void deleteRPCFromDB() {
    	...
    	db.deleteFromFile(db.getRPCListFile(), remoteHost);
    }
	...
	//			System.out.println(socket.getInetAddress()+" : "+socket.getPort());
            	...
            	bg = new BlockGenerator(newTransaction, pm,socket,km);
            	bg.start();
			}
			ois.close();
