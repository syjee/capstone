            ...
            { 
                ...
                { 
                    ...
                    { 
                        ...
                        { 
                            if (outputBuffer.get(i).getCurrentHash().length() > 20) 
                            { 
                                System.out.println("[Peer]Send Block:" + outputBuffer.get(i).getCurrentHash().substring(0, 20) + " to " + socket.getInetAddress()+" : "+socket.getPort()); 
                            } 
                            else 
                            { 
                                System.out.println("[Peer]Send Block:" + outputBuffer.get(i).getCurrentHash() + " to " + socket.getInetAddress()+" : "+socket.getPort()); 
                            } 
