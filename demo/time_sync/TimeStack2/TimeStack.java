 ...
 public void initialize() {
  ...
  button2_1.addActionListener(new ActionListener() {
   public void actionPerformed(ActionEvent arg0) {
    ...
    LineBorder BC1_0BorderA = new LineBorder(Color.DARK_GRAY, 4, true);
    EmptyBorder BC1_0BorderB = new EmptyBorder(20, 80, 20, 80); 
    panelBC1_0.setBorder(new CompoundBorder(BC1_0BorderA, BC1_0BorderB));
    ...
    //panelBC1_1.getContentPane().add(panelBC1_1, BorderLayout.NORTH);
    panelBC1_1.setBackground(SystemColor.activeCaption);
    panelBC1_0.add(panelBC1_1);
    //panelBC1.setLayout(new BoxLayout(panelBC1_1, BoxLayout.X_AXIS));
    ...
    buttonBC2_1.setBorder(new LineBorder(SystemColor.activeCaption, 5, true));
    ...
    buttonBC2_1.addActionListener(new ActionListener() {
     public void actionPerformed(ActionEvent arg0) {
      ...
      shIPList.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\dev\\workspace\\GUI\\TS1.png"));
      //"/home/pi/workspace/Time-Sync/TS.png"));
      ...
      shIPList.getContentPane().add(panelshI1, BorderLayout.NORTH);
      panelshI1.setBackground(Color.DARK_GRAY);
      panelshI1.setLayout(new BoxLayout(panelshI1, BoxLayout.X_AXIS));
      /**패널shI1 안에 레이블shI1*/
      ...
      EmptyBorder shI2BorderA = new EmptyBorder(30, 25, 25, 25); 
      LineBorder shI2BorderB = new LineBorder(Color.DARK_GRAY, 5, true);
      panelshI2.setBorder(new CompoundBorder(shI2BorderA, shI2BorderB));
      shIPList.getContentPane().add(panelshI2, BorderLayout.CENTER);
      panelshI2.setLayout(new BoxLayout(panelshI2, BoxLayout.X_AXIS));
      /**패널shI2 안에 패널shI2_1*/
      ...
      labelshI2_1_1.setVerticalAlignment(SwingConstants.CENTER);
      labelshI2_1_1.setHorizontalAlignment(SwingConstants.LEFT);
      ...
      textFieldshI2_2_1.setBorder(new LineBorder(Color.DARK_GRAY, 2));
      textFieldshI2_2_1.setFont(new Font("함초롬돋움", Font.BOLD, 26));
      textFieldshI2_2_1.setHorizontalAlignment(SwingConstants.CENTER);
      ...
      shIPList.getContentPane().add(panelshI3, BorderLayout.SOUTH);
      panelshI3.setBackground(Color.WHITE);
      panelshI3.setLayout(new BoxLayout(panelshI3, BoxLayout.Y_AXIS));
      /**패널shI3 안에 패널shI3_0*/
      //panelshI3_0 = new JPanel();
      LineBorder shI3_0BorderA = new LineBorder(Color.WHITE, 2, true);
      EmptyBorder shI3_0BorderB = new EmptyBorder(10, 10, 10, 10); 
      panelshI3_0.setBorder(new CompoundBorder(shI3_0BorderA, shI3_0BorderB));
      ...
      DefaultListModel shI3_1 = new DefaultListModel();
      ...
      //listshI3_1.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
      EmptyBorder shI3_1BorderA = new EmptyBorder(20, 20, 20, 20); 
      LineBorder shI3_1BorderB = new LineBorder(Color.WHITE, 2, true);
      listshI3_1.setBorder(new CompoundBorder(shI3_1BorderA, shI3_1BorderB));
      listshI3_1.setBackground(Color.WHITE);
      listshI3_1.setForeground(Color.BLACK);
      Iscroller = new JScrollPane(listshI3_1);
      Iscroller.setBorder(new LineBorder(SystemColor.activeCaption, 4, true));
    ...
    buttonBC2_2.setBorder(new LineBorder(SystemColor.activeCaption, 5, true));
    ...
    buttonBC2_2.addActionListener(new ActionListener() {
     public void actionPerformed(ActionEvent arg0) {
      ...
      shPeerList.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
      shPeerList.setTitle("Show Peer List");
      shPeerList.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\dev\\workspace\\GUI\\TS1.png"));
      //"/home/pi/workspace/Time-Sync/TS.png"));
      ...
      shPeerList.getContentPane().add(panelshP1, BorderLayout.NORTH);
      panelshP1.setBackground(Color.DARK_GRAY);
      panelshP1.setLayout(new BoxLayout(panelshP1, BoxLayout.X_AXIS));
      /**패널shP1 안에 레이블shP1*/
      ...
      EmptyBorder shP2BorderA = new EmptyBorder(30, 25, 25, 25); 
      LineBorder shP2BorderB = new LineBorder(Color.DARK_GRAY, 5, true);
      panelshP2.setBorder(new CompoundBorder(shP2BorderA, shP2BorderB));
      shPeerList.getContentPane().add(panelshP2, BorderLayout.CENTER);
      panelshP2.setLayout(new BoxLayout(panelshP2, BoxLayout.X_AXIS));
      /**패널shP2 안에 패널shP2_1*/
      ...
      labelshP2_1_1.setVerticalAlignment(SwingConstants.CENTER);
      labelshP2_1_1.setHorizontalAlignment(SwingConstants.LEFT);
      ...
      labelshP2_1_2.setVerticalAlignment(SwingConstants.CENTER);
      labelshP2_1_2.setHorizontalAlignment(SwingConstants.LEFT);
      ...
      labelshP2_1_3.setVerticalAlignment(SwingConstants.CENTER);
      labelshP2_1_3.setHorizontalAlignment(SwingConstants.LEFT);
      ...
      labelshP2_1_4.setVerticalAlignment(SwingConstants.CENTER);
      labelshP2_1_4.setHorizontalAlignment(SwingConstants.LEFT);
      ...
      textFieldshP2_2_1.setBorder(new LineBorder(Color.DARK_GRAY, 2));
      textFieldshP2_2_1.setFont(new Font("함초롬돋움", Font.BOLD, 26));
      textFieldshP2_2_1.setHorizontalAlignment(SwingConstants.CENTER);
      ...
      textFieldshP2_2_2.setBorder(new LineBorder(Color.DARK_GRAY, 2));
      textFieldshP2_2_2.setFont(new Font("함초롬돋움", Font.BOLD, 26));
      textFieldshP2_2_2.setHorizontalAlignment(SwingConstants.CENTER);
      ...
      textFieldshP2_2_3.setBorder(new LineBorder(Color.DARK_GRAY, 2));
      textFieldshP2_2_3.setFont(new Font("함초롬돋움", Font.BOLD, 26));
      textFieldshP2_2_3.setHorizontalAlignment(SwingConstants.CENTER);
      ...
      textFieldshP2_2_4.setBorder(new LineBorder(Color.DARK_GRAY, 2));
      textFieldshP2_2_4.setFont(new Font("함초롬돋움", Font.BOLD, 26));
      textFieldshP2_2_4.setHorizontalAlignment(SwingConstants.CENTER);
      textFieldshP2_2_1.setEditable(false);
      ...
      shPeerList.getContentPane().add(panelshP3, BorderLayout.SOUTH);
      panelshP3.setBackground(Color.WHITE);
      panelshP3.setLayout(new BoxLayout(panelshP3, BoxLayout.Y_AXIS));
      /**패널shP3 안에 패널shP3_0*/
      //panelshP3_0 = new JPanel();
      LineBorder shP3_0BorderA = new LineBorder(Color.WHITE, 2, true);
      EmptyBorder shP3_0BorderB = new EmptyBorder(10, 10, 10, 10); 
      panelshP3_0.setBorder(new CompoundBorder(shP3_0BorderA, shP3_0BorderB));
      ...
      /**패널shI3_1 안에 리스트shI3_1*/
      DefaultListModel shP3_1 = new DefaultListModel();
      ...
      //listshP3_1.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
      EmptyBorder shP3_1BorderA = new EmptyBorder(20, 20, 20, 20); 
      LineBorder shP3_1BorderB = new LineBorder(Color.WHITE, 2, true);
      listshP3_1.setBorder(new CompoundBorder(shP3_1BorderA, shP3_1BorderB));
      listshP3_1.setBackground(Color.WHITE);
      listshP3_1.setForeground(Color.BLACK);
      Pscroller = new JScrollPane(listshP3_1);
      Pscroller.setBorder(new LineBorder(SystemColor.activeCaption, 4, true));
    ...
    buttonBC2_3.setBorder(new LineBorder(SystemColor.activeCaption, 5, true));
    ...
    buttonBC2_3.addActionListener(new ActionListener() {
     public void actionPerformed(ActionEvent arg0) {
      ...
      shBlockchain.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
      shBlockchain.setTitle("Show Blockchain");
      shBlockchain.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\dev\\workspace\\GUI\\TS1.png"));
      //"/home/pi/workspace/Time-Sync/TS.png"));
      shBlockchain.getContentPane().setBackground(Color.WHITE);
    ...
    buttonBC2_4.setBorder(new LineBorder(SystemColor.activeCaption, 5, true));
    ...
    buttonBC2_4.addActionListener(new ActionListener() {
     public void actionPerformed(ActionEvent arg0) {
      ...
      shTSHistory.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
      shTSHistory.setTitle("Show Time Sync History");
      shTSHistory.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\dev\\workspace\\GUI\\TS1.png"));
      //"/home/pi/workspace/Time-Sync/TS.png"));
         ...
         public void actionPerformed(ActionEvent arg0) {
          ...
          //  tr.initTimeServer();
            ...
            if(TimeServer.equals("")) {
             tr.initTimeServer();
             TimeServer = tr.getTimeServer();
            }
            else tr.setTimeServer(TimeServer);
            */
            tr.timereceive();
            tr.timesynchronize();
  ...
  new Thread() {
   public void run() {
    while (true) {
     ...
     /*
     if(TimeServer.equals("")) {
      time_packet.initTimeServer();
      TimeServer = time_packet.getTimeServer();
     } else time_packet.setTimeServer(TimeServer);
     */
