...
{ 
    ...
    public RPCThread(Socket socket,PeerNetworkManager pm,Blockchain bc,KeyManager km,BlockNetworkManager bnm) 
    { 
        this.socket = socket; 
        this.pm = pm;
        this.db = new DBHelper();
    ...
    { 
        ...
        inputThread = new RPCInput(socket,pm,bc,km,bnm); 
        inputThread.start(); 
    ...
    */
    ...
    { 
        if (outputThread == null) 
        { 
            System.out.println("[RPC]Couldn't send Transaction : " + newBlock.getStringTransaction().substring(0,20) + "... !!!!"); 
        } 
        else 
        { 
