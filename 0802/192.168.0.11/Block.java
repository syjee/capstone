...
public class Block implements Serializable {
	...
	public Block(int index, String transaction, String previousHash,
			String currentHash) {
	...
	public Block(int index, ArrayList<Transaction> transactions,
	...
	public String getRawBlock() {
		...
		/*
		 * for(int i = 0; i<transactions.size(); i++){ rawBlock +=
	...
	public String calculateHash() throws NoSuchAlgorithmException {
		...
		MessageDigest digest = MessageDigest.getInstance("SHA-256");
		byte[] hash = digest.digest(calculatedhash
	...
	public boolean mineBlock(int difficulty) throws NoSuchAlgorithmException {
		...
		try {
			...
			System.out
					.println("[MINE]Mining Success!!! nonce = " + (nonce - 1));
			isMined = true;
